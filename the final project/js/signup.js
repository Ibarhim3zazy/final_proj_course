...
if(fname.length > 2 &&
  ...
  Tfname.test(fname)== true){
		...
		document.getElementById('firstname_error').innerHTML="please fill up your phone number";
...
Tlname.test(lname)== true){
	...
	document.getElementById('lastname_error').innerHTML="please fill up your phone number";
...
if(email.length > 12 &&
	...
	document.getElementById('email_error').innerHTML="please fill up your phone number";
...
if(phone.length === 11 &&
	Tphone.test(phone)== true){
		...
		document.getElementById('phone_error').innerHTML="please fill up your password";
